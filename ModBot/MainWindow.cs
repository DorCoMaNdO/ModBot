...
namespace ModBot
{
    public partial class MainWindow : CustomForm
    {
                            ...
                            if (KeyValue.Key != "")
                            {
                                ...
                                else if (KeyValue.Key.Equals("Giveaway_BanList"))
                                {
                                    ...
                                    foreach (string ban in bans)
                                    {
                                        ...
                                        if (!ban.Equals("") && !Giveaway_BanListListBox.Items.Contains(ban))
                                        {
                                            Giveaway_BanListListBox.Items.Add(ban);
                                        }
                                    }
                                }
                            }
        ...
        {
            List<Transaction> transactions = IRC.api.UpdateTransactions();
            ...
            string sName = IRC.capName(IRC.channel.Substring(1)), sTitle = "Unavailable...", sGame = "Unavailable...", sViewers = "";
            int iStatus = 0;
        ...
        private void Giveaway_AnnounceWinnerButton_Click(object sender, EventArgs e)
        {
            ...
            if (IRC.api.IsFollowingChannel(Giveaway_WinnerLabel.Text))
            {
        ...
        private void Giveaway_WinnerTimer_Tick(object sender, EventArgs e)
        {
            ...
            {
                int time = IRC.api.GetUnixTimeNow() - IRC.ActiveUsers[Giveaway_WinnerLabel.Text];
                int color = time - 120;
            ...
            {
                int time = IRC.api.GetUnixTimeNow() - IRC.giveaway.iLastWin;
                int color = time;
                if (color >= 0 && color < 60)
                {
                    color = 200 / 60 * color;
